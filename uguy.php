            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <a href="#" class="nav-link"><i class="fa fa-bell me-lg-2 "></i>Place Order </a>
                    
                        <a href="#" class="nav-link"><i class="fa fa-bell me-lg-2 "></i>History </a>
...
?>
    ...
    <div class="2">
     <img src="../foodstall_logo/<?php echo $row_product['logo']; ?>" width="100%"; height="100%";>
      ...
      <button> <a href="view_foodstall_product.php?id=<?php echo $row_product['foodstallname']; ?>">View Product</a></button>
