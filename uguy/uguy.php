...
$orders_form=mysqli_query($conn,"SELECT * FROM orders WHERE status='Pending'");
while($row_orders=mysqli_fetch_array($orders_form)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><button><a href="uguy_acccept_order.php?id=<?php echo $row_orders['id'];?>" style="color: red;">View Order Details</a></button></td>
