            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <a href="accepted_order.php" class="nav-link active"  style="color: red;"><i class="fa fa-bell me-lg-2 "></i>Accepted Order </a>
...
$orders_form=mysqli_query($conn,"SELECT * FROM orders WHERE status='Accepted' AND uguy_firstname='$fname' AND uguy_lastname='$lname' AND delivered='Pending'");
while($row_orders=mysqli_fetch_array($orders_form)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><button><a href="view_accepted_order.php?id=<?php echo $row_orders['id'];?>">View Order Details</button></td>
    </tr>
