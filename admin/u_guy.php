...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Delivery Guy Name</th>
...
$uguy=mysqli_query($conn,"SELECT * FROM uguy");
while($uguy_list=mysqli_fetch_array($uguy)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><?php echo$uguy_list['firstname'];echo " ";  echo$uguy_list['lastname']?></td>
       <td><?php echo $uguy_list['student_idnumber']?></td>
      <td><?php echo $uguy_list['contact']?></td>
       <td><?php echo $uguy_list['department']?></td>
       <td><?php echo $uguy_list['email']?></td>
    </tr>
