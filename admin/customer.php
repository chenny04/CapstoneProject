...
while($customer_list=mysqli_fetch_array($customer)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><?php echo$customer_list['firstname']; echo " "; echo$customer_list['lastname']?></td>
       <td><?php echo $customer_list['student_idnumber']?></td>
      <td><?php echo $customer_list['contact']?></td>
       <td><?php echo $customer_list['department']?></td>
