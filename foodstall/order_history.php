            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span>Food Stall Owner Name:</span><h1><?php echo $foodstallname; ?></h1>
                    </div>
                </div>
                        
                        <a href="index.php" class="nav-link "><i class="fa fa-bell me-lg-2 "></i>Dashboard</a>
                        <a href="order_history.php" class="nav-link " style="color: red;"><i class="fa fa-bell me-lg-2 "></i>Orders History</a>
...
$orders_form=mysqli_query($conn,"SELECT * FROM orders WHERE foodstall='$foodstallname' ");
 ...
 ?>
  ...
  <tbody>
      ...
      <td><?php echo $row_orders['room']?></td>
       <td><?php echo $row_orders['delivered']?></td>
