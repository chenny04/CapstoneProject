...
$orders_form=mysqli_query($conn,"SELECT * FROM orders WHERE customer_firstname='$fname' AND customer_lastname='$lastname' AND delivered='Pending'");
while($row_orders=mysqli_fetch_array($orders_form)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><button><a href="view_customer_order.php?id=<?php echo $row_orders['id'];?>" class="red-font">View Order Details</a></button></td>
