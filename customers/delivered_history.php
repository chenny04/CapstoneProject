            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                       ...
                       <a href="index.php" class="nav-link orange-font"><i class="fa fa-bell me-lg-2"></i>Food Stalls</a>
                       <a href="order_status.php" class="nav-link orange-font"><i class="fa fa-bell me-lg-2"></i>Order Status</a>
                        <a href="delivered_history.php" class="nav-link active"  style="color: red;"><i class="fa fa-bell me-lg-2 "></i>Delivered History</a>
...
$orders_form=mysqli_query($conn,"SELECT * FROM orders WHERE customer_firstname='$fname' AND customer_lastname='$lastname' AND delivered='Delivered'");
while($row_orders=mysqli_fetch_array($orders_form)){
 ...
 ?>
  ...
  <tbody>
      ...
      <td><button><a href="view_delivered_order.php?id=<?php echo $row_orders['id'];?>" class="red-font">View Order Details</a></button></td>
...
<?php } ?>
        ...
        <!-- Back to Top -->
        <a href="delivered_history.php" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    </div>
