   ...
   session_start();
    ...
    $orders=mysqli_query($conn,"SELECT * FROM orders WHERE id='$get_id_order'");
        while ($row = mysqli_fetch_object($orders)){
            ...
            $room=$row->room;
            $id=$row->id;
            $uguy_fname=$row->uguy_firstname;
             $uguy_lname=$row->uguy_lastname;
...
<body>
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span><?php echo $fname; echo " ";echo $lastname;?></span>
                          ...
                          <a href="index.php" class="nav-link "> <i class="fa fa-bell me-lg-2 "></i>Food stalls</a>
                        <a href="order_status.php" class="nav-link active"  style="color: red;"><i class="fa fa-bell me-lg-2 "></i>Order Status </a>
        ...
        <div class="content">
            ...
            <div class="mb-3">
                        <label for="" class="form-label">Delivery GUY Firstname:</label>
                        <input type="text" class="form-control" name="dfn"  value="<?php echo $uguy_fname;?> " readonly>
                    </div>


            <div class="mb-3">
                        <label for="" class="form-label">Delivery GUY Lastname:</label>
                        <input type="text" class="form-control" name="dln"  value="<?php echo $uguy_lname;?> " readonly>
                    </div>

                <button><a href="delivered_order.php?id=<?php echo $id;?>">Delivered</button>
