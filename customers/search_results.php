...
<body>
        ...
        <div class="content">
            ...
            <div id="search_results"  class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
...
if(isset($_GET['query']) && !empty($_GET['query'])) {
    ...
    $search_result = mysqli_query($conn, "SELECT * FROM food_products WHERE product_name LIKE '%$search_query%'");
    ...
    if(mysqli_num_rows($search_result) > 0) {
        while($row_product = mysqli_fetch_array($search_result)) {
            
            echo "<div>";
            echo "<img src='../foodstall/food_product/" . $row_product['product_picture'] . "' width='100%' height='100%'>";
            echo "<span>" . $row_product['product_name'] . "</span><br>";
            echo "<span>Price: Php " . $row_product['price'] . "</span><br>";
            echo "<button><a href='order_form.php?food_id=" . $row_product['id'] . "'>Buy</a></button>";
            echo "</div>";
        }
    } else {
